...
{
	void BigInt::sub(const BigInt &num1, const BigInt &num2)
	{
	...
	void BigInt::subIp(const BigInt &num1)
	{
		if ((m_sign == SIGN_POSITIVE) && (m_sign == SIGN_POSITIVE)) {
			usubIp(num1);
		} else if ((m_sign == SIGN_POSITIVE) && (m_sign == SIGN_NEGATIVE)) {
			uaddIp(num1);
		} else if ((m_sign == SIGN_NEGATIVE) && (m_sign == SIGN_POSITIVE)) {
			uaddIp(num1);
			m_sign = SIGN_NEGATIVE;
		} else if ((m_sign == SIGN_NEGATIVE) && (m_sign == SIGN_NEGATIVE)) {
			usubIp(num1);
